...
public class AddCustomerSteps {
	...
	@Given("the user is in add tarif page")
	public void the_user_is_in_add_tarif_page() {
		System.setProperty("webdriver.chrome.driver","C:\\UsersLakshmi\\CloneTry\\eclipse-workspace\\cucumber\\driver\\chromedriver.exe");
	...
	@When("the customer fill the valid data in fields")
	public void the_customer_fill_the_valid_data_in_fields(DataTable customerDetails) {
	...
	@Then("the form should be refresh")
	public void the_form_should_be_refresh() {
